    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          <Img src={`${process.env.NEXT_PUBLIC_SERVER_URL}/kncstudio.png`} width="150" height="150" alt="DigitalHippo" style={logo} />
          <Text style={paragraph}>Hi there,</Text>
          <Text style={paragraph}>Welcome to KncStudio, the marketplace for high quality digital goods. Use the button below to {actionLabel}.</Text>
