            ...
            <div>
              <div className="relative flex items-center px-6 py-6 sm:py-8 lg:mt-0">
                <div className="absolute inset-0 overflow-hidden rounded-lg">
                  <div aria-hidden="true" className="absolute bg-dark inset-0 bg-gradient-to-br bg-opacity-90" />
                </div>
                ...
                <div className="text-center relative mx-auto max-w-sm">
                  ...
                  <p className="mt-2 text-sm text-white/70">
                    ...
                    <Link href="/sign-in?as=seller" className="whitespace-nowrap font-medium text-white hover:text-white/90">
                      Get started &rarr;
                    </Link>
                  </p>
                </div>
